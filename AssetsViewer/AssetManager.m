...
- (void)setAssetManagerModeIsHoldItemData:(BOOL)isHold
{
    ...
    if( isHold == YES ){
        if( _arrayOfAssetsInfo == nil ){
            _arrayOfAssetsInfo = [[NSMutableArray alloc] init];
        }
    }
}
...
// ------- internal functions -------------------------------------------------------------------------
- (NSMutableDictionary*)getMetadataByAsset:(ALAsset*)asset dictionary:dict
{
    //NSMutableDictionary* dict = [[NSMutableDictionary alloc] init];
    @autoreleasepool {
        ALAssetRepresentation* assetRepresentaion = [asset defaultRepresentation];
...
- (UIImage*)getThumbnailByAsset:(ALAsset *)asset
{
    @autoreleasepool {
        UIImage* image = [UIImage imageWithCGImage:[asset thumbnail]];
        return image;
...
- (UIImage*)getAspectThumbnailByAsset:(ALAsset *)asset
{
    @autoreleasepool {
        UIImage* image = [UIImage imageWithCGImage:[asset aspectRatioThumbnail]];
        return image;
